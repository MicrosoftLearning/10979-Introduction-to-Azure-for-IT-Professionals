...
1. If you are presented with the **Welcome to Azure Cloud Shell** pane, click **Bash (Linux)**.  (If you've used the Cloud Shell before and it defaults to **PowerShell**, click the **PowerShell** drop-down and select **Bash**.  Continue to **Task 2**) 
...
1. When prompted, type the following values and press Enter after each:
    ...
    - dnsNameForPublicIP: any valid, unique name beginning with lowercase letters and ending in numbers
